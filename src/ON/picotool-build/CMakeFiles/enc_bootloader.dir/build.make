...
CMakeFiles/enc_bootloader-complete: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install
	...
	/usr/bin/cmake -E touch /workspace/src/ON/picotool-build/CMakeFiles/enc_bootloader-complete
	/usr/bin/cmake -E touch /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-done
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-build: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure
	cd /workspace/src/ON/picotool-build/enc_bootloader && $(MAKE)
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch
	cd /workspace/src/ON/picotool-build/enc_bootloader && /usr/bin/cmake -DCMAKE_MAKE_PROGRAM:FILEPATH=/usr/bin/gmake -DPICO_SDK_PATH:FILEPATH=/workspace/build_docker/_deps/pico_sdk-src -DUSE_PRECOMPILED:BOOL=true -DUSE_MBEDTLS=0 -DPICO_DEBUG_INFO_IN_RELEASE=OFF "-GUnix Makefiles" /workspace/src/ON/picotool-src/enc_bootloader
	cd /workspace/src/ON/picotool-build/enc_bootloader && /usr/bin/cmake -E touch /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir
	...
	/usr/bin/cmake -E touch /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-build
	cd /workspace/src/ON/picotool-build/enc_bootloader && /usr/bin/cmake -E echo_append
	cd /workspace/src/ON/picotool-build/enc_bootloader && /usr/bin/cmake -E touch /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir:
	...
	/usr/bin/cmake -E make_directory /workspace/src/ON/picotool-build/enc_bootloader
	/usr/bin/cmake -E make_directory /workspace/src/ON/picotool-build/enc_bootloader
	/usr/bin/cmake -E make_directory /workspace/src/ON/picotool-build/enc_bootloader/tmp
	/usr/bin/cmake -E make_directory /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp
	/usr/bin/cmake -E make_directory /workspace/src/ON/picotool-build/enc_bootloader/src
	/usr/bin/cmake -E make_directory /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp
	/usr/bin/cmake -E touch /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /workspace/src/ON/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update
...
CMakeFiles/enc_bootloader.dir/depend:
	cd /workspace/src/ON/picotool-build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspace/src/ON/picotool-src /workspace/src/ON/picotool-src /workspace/src/ON/picotool-build /workspace/src/ON/picotool-build /workspace/src/ON/picotool-build/CMakeFiles/enc_bootloader.dir/DependInfo.cmake --color=$(COLOR)
